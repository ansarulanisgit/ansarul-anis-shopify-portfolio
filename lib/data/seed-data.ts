...
export const defaultSiteSettings: SiteSettingsMap = {
  ...
  notification_email: 'ansarul.contact@gmail.com',
  email_sender_name: 'AnisShopify Contact',
  email_subject_template: '⚡ New Lead: {subject} ({name})',
  email_header_title: '⚡ New Client Inquiry • AnisShopify',
  email_template_style: 'modern',
  email_accent_color: '#FF2A51',
  email_provider: 'smtp',
  smtp_host: 'smtp.gmail.com',
  smtp_port: 465,
  smtp_user: 'ansarul.contact@gmail.com',
  smtp_pass: '',
  resend_api_key: '',
