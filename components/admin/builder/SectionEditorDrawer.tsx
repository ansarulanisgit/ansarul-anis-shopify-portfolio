                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="font-semibold text-foreground">
                      {section.section_type === 'hero' ? 'Headline Prefix (Static text)' : 'Main Heading'}
                    </label>
                    <Input
                      ...
                      placeholder="e.g. Shopify Website Design That"
                    />
                  </div>
                  ...
                  {section.section_type === 'hero' && (
                    <>
                      <div className="space-y-1.5">
                        <label className="font-semibold text-foreground">
                          Animated Rotating Phrases (Typewriter Effect)
                        </label>
                        <Textarea
                          value={
                        ...
                        <p className="text-[11px] text-muted-foreground">
                          Enter one phrase per line. Sequentially typed and erased with theme gradient colors.
                        </p>
                      </div>
                  ...
                  {/* Content Blocks (for custom & stats sections) */}
                  {caps.supportsBlocks && (
                    <div className="pt-4 border-t border-border space-y-3">
                      ...
                      <div className="space-y-2.5">
                        {(settings.blocks || []).map((block, bIdx) => (
